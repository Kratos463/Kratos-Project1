...
import { IoPersonOutline, IoSettingsOutline, IoWalletOutline } from "react-icons/io5";
                ...
                >
                    ...
                    <Flex align="center">
                        <Menu >
                            ...
                            <MenuList size='sm' bg="#040930" borderRadius="1px" shadow="lg" p={0}>
                                <MenuItem bg="#681bccdd" color="whitesmoke" mb="15px"> <Avatar
                                    mr="10px"
                                    size="sm"
                                    name="Abhishek"
                                    src="https://avatars2.githubusercontent.com/u/37842853?v=4"
                                ...
                                <ProfileDropDown user={user}>
                                    <MenuItem bg="transparent" color="whitesmoke" > <Icon as={IoPersonOutline}  mr="10px"/>My Profile</MenuItem>
                                </ProfileDropDown>
                                <MenuItem bg="transparent" color="whitesmoke" mt="10px"> <Icon as={BiLogOutCircle}  mr="10px"/>Logout</MenuItem>
                            </MenuList>
                        </Menu>
                    </Flex>
                </Flex>
    ...
    >
        ...
        <Flex direction="column" as="nav" fontSize="md" color={"whitesmoke"} aria-label="Main Navigation">
            ...
            <NavItemWithSubMenu icon={RiMastercardLine} title="Master">
                <NavItem to='/admin/master/country-master'>Country Master</NavItem>
                <NavItem to='/admin/master/operator-master'>Operator Master</NavItem>
                <NavItem to='/admin/master/department-master'>Department Master</NavItem>
                <NavItem to='/admin/master/gift-code-creation'>Gift Code Creation</NavItem>
                <NavItem>Member Type</NavItem>
                <NavItem to='/admin/master/rank-master'>Rank Master</NavItem>
                <NavItem to='/admin/master/package-master'>Package Master</NavItem>
                <NavItem to='/admin/master/product-master'>Product Master</NavItem>
                <NavItem to='/admin/master/subscription-master'>Subscription Product Master</NavItem>
            </NavItemWithSubMenu>

            <NavItemWithSubMenu icon={AiOutlineTeam} title="Member Management">
                <NavItem to='/admin/member-management/members'>All Memebers</NavItem>
                <NavItem to='/admin/member-management/special-email'>Create Special Emails</NavItem>
                <NavItem>ID Transfer Request</NavItem>
                <NavItem to='/admin/member-management/dummy-power'>Allot Dummy Power to Leader</NavItem>
                <NavItem to='/admin/member-management/gift-code'>Allot Zero Valued Gift Codes</NavItem>
            </NavItemWithSubMenu>

            <NavItem icon={FaRegNewspaper} to='/newsletter'>Newsletter</NavItem>   

            <NavItemWithSubMenu icon={IoSettingsOutline} title="Settings">
                <NavItem to='/admin/setting/income'>Income Settings</NavItem>
