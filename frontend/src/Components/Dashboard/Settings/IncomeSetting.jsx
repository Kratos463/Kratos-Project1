...
import { Tabs, TabList, TabPanels, Tab, TabPanel, Box, Button, FormControl, FormLabel, Input, Flex, Text } from '@chakra-ui/react'

const IncomeSetting = () => {
  return (
    <Box p="10px" minH="500px" style={{ backgroundColor: 'var(--secondary-bgcolor)' }}>
      <Tabs isFitted >
        <TabList>
