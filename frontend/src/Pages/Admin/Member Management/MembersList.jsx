...
import {
    ...
    Select, Table, Tbody, Td, Th, Thead, Tr, Divider, Text
} from '@chakra-ui/react';
import { EditIcon } from '@chakra-ui/icons';
import useFilteredData from '../../../Hooks/useFilteredData'
import moment from 'moment-timezone';
import { countries, memberList } from '../../../Components/Data/dummy';
...
const MemberTable = ({ openModal }) => {
    ...
    return (
        <>
            <Flex mb={5}>
                <Text fontSize="18px" fontWeight="700" color="white" flex={1}>Member's List</Text>
